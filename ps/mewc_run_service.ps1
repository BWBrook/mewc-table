...
# C:\camera_traps\mewc\mewc_run_service.ps1 -i C:\camera_traps\ -p C:\camera_traps\mewc\mewc.env -c C:\camera_traps\mewc\class_map.yaml -m C:\camera_traps\mewc\model.keras -g 0
